...
import br.com.awasis.manangerbackend.service.tipoProduto.TipoProdutoService;
...
public class TipoProdutoController {
    ...
    public List findByProperties(@RequestBody TipoProduto tf){
        return service.find(tf);
    }
    
    @PostMapping
    public TipoProduto save(@RequestBody TipoProduto tf){
        return service.save(tf);
    }
    
    @PutMapping(path = {"/{id}"})
    public ResponseEntity update(@PathVariable long id, @RequestBody TipoProduto tf){
