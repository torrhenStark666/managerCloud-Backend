...
import br.com.awasis.manangerbackend.service.grupoProduto.GrupoProdutoService;
...
public class GrupoProdutoController {
    ...
    public List findByProperties(@RequestBody GrupoProduto gf){
        return service.find(gf);
    }
    
    @PostMapping
    public GrupoProduto save(@RequestBody GrupoProduto gf){
    ...
    @PutMapping(path = {"/{id}"})
    public ResponseEntity update(@PathVariable long id, @RequestBody GrupoProduto gf){
