...
import br.com.awasis.manangerbackend.service.natureza.NaturezaService;
...
public class NaturezaController {
    ...
    public List findByProperties(@RequestBody Natureza gf){
        return service.find(gf);
    }
    
    @PostMapping
    public Natureza save(@RequestBody Natureza gf){
    ...
    @PutMapping(path = {"/{id}"})
    public ResponseEntity update(@PathVariable long id, @RequestBody Natureza gf){
