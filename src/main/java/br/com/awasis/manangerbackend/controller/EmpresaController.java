...
public class EmpresaController {
    ...
    public List findByProperties(@RequestBody Empresa gf){
        return service.find(gf);
    }
    
    @PostMapping
    public Empresa save(@RequestBody Empresa gf){
    ...
    @PutMapping(path = {"/{id}"})
    public ResponseEntity update(@PathVariable long id, @RequestBody Empresa gf){
