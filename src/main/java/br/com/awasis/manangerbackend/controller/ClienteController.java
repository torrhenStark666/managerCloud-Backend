...
import br.com.awasis.manangerbackend.service.cliente.ClienteService;
...
public class ClienteController {
    ...
    @PostMapping
    public Cliente save(@RequestBody Cliente b){
        return service.save(b);
    }
    
    @PostMapping(path = {"/find"})
    public List findByProperties(@RequestBody Cliente b){
        return service.find(b);
    }
    
    @PutMapping(path = "/{id}")
    public ResponseEntity update(@PathVariable long id, @RequestBody Cliente b){
