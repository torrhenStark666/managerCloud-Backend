...
import br.com.awasis.manangerbackend.service.formaPagamento.FormaPagamentoService;
...
public class FormaPagamentoController {
    ...
    public List findByProperties(@RequestBody FormaPagamento gf){
        return service.find(gf);
    }
    
    @PostMapping
    public FormaPagamento save(@RequestBody FormaPagamento gf){
    ...
    @PutMapping(path = {"/{id}"})
    public ResponseEntity update(@PathVariable long id, @RequestBody FormaPagamento gf){
