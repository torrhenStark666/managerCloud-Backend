...
import br.com.awasis.manangerbackend.service.grupoCliente.GrupoClienteService;
...
@AllArgsConstructor
@RestController
@RequestMapping({"/grupos-clientes"})
public class GrupoClienteController {
    ...
    public List findByProperties(@RequestBody GrupoCliente gf){
        return service.find(gf);
    }
    
    @PostMapping
    public GrupoCliente save(@RequestBody GrupoCliente gf){
    ...
    @PutMapping(path = {"/{id}"})
    public ResponseEntity update(@PathVariable long id, @RequestBody GrupoCliente gf){
