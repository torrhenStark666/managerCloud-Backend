...
public class RoleController {
    ...
    @PostMapping
    public Role save(@RequestBody Role b){
        System.out.println(b);
        return service.save(b);
    }
    
    @PostMapping(path = {"/find"})
    public List findByProperties(@RequestBody Role b){
        return service.find(b);
    }
    
    @PutMapping(path = "/{id}")
    public ResponseEntity update(@PathVariable long id, @RequestBody Role b){
        System.out.println(b);
