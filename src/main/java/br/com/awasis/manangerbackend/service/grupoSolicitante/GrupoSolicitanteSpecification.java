...
import br.com.awasis.manangerbackend.model.GrupoSolicitante_;
 ...
 * @author alecsander
 */
public class GrupoSolicitanteSpecification {
    
    public static Specification byIdSpecification(long id){
        return (Root root, CriteriaQuery query, CriteriaBuilder builder) ->{
            Predicate equalPredicate = builder.equal(root.get(GrupoSolicitante_.idGrupoSolicitante), id);
    ...
    public static Specification byDescricaoSpecification(String descricao){
        return (Root root, CriteriaQuery query, CriteriaBuilder builder) ->{
            Predicate equalPredicate = builder.equal(root.get(GrupoSolicitante_.descricao), "%"+descricao.trim()+"%");
            return equalPredicate;
        };
    }
