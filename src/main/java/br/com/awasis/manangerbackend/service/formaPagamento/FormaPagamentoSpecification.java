...
public class FormaPagamentoSpecification {
    ...
    public static Specification byIdSpecification(long id){
        return (Root root, CriteriaQuery query, CriteriaBuilder builder) ->{
            Predicate equalPredicate = builder.equal(root.get(FormaPagamento_.idFormaPagamento), id);
    ...
    public static Specification byDescricaoSpecification(String descricao){
        return (Root root, CriteriaQuery query, CriteriaBuilder builder) ->{
          Predicate equalPredicate = builder.like(root.get(FormaPagamento_.descricao), "%"+descricao+"%");
          return equalPredicate;
        };
    }
    ...
    public static Specification byAtivoSpecification(boolean ativo){
        return (Root root, CriteriaQuery query, CriteriaBuilder builder) ->{
          Predicate equalPredicate = builder.equal(root.get(FormaPagamento_.ativo), ativo);
          return equalPredicate;
        };
    }
